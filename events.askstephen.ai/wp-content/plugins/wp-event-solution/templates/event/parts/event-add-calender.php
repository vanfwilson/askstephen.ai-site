    ...
    <div class="container">
        <div class="etn-add-calender">
            ...
            <ul id="etn_add_calender_links" class="etn-calender-list">
                ...
                <li>
                    <a href ="https://outlook.live.com/calendar/0/deeplink/compose?rru=addevent&enddt=<?php echo esc_html($outlook_event_end); ?>&startdt=<?php echo esc_html($outlook_event_start); ?>&allday=false&subject=<?php echo esc_html( Helper::convert_to_calendar_title( $event->post_title ) ); ?>&body=<?php echo esc_html( substr( Helper::content_to_html( $event->post_content ), 0, 1000 ) ); ?>" rel="noopener noreferrer" target='_blank' class='etn-add-to-calender' rel="nofollow"> 
                        <div class="calender-icon">

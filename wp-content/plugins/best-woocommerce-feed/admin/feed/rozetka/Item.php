...
use RexTheme\Rozetka\Node;
use RexTheme\Rozetka\Containers\RexShopping;
...
class Item
{
    ...
    {
        $node = new Node('available');
        $this->nodes['available'] = $node->value($available)->_namespace($this->namespace);
    }*/

...
namespace RexTheme\ZapCoIl\Containers;

use RexTheme\ZapCoIl\Feed;
...
class ZapCoIl
{
    ...
    public static function container()
    {
        if (is_null(static::$container)) {
            static::$container = new Feed( static::$wrapper, static::$itemName, static::$namespace, static::$version , static::$rss, static::$stand_alone, static::$wrapperel, '', static::$url, static::$date, static::$time );
        }
     ...
     * @return Feed
     */
    public static function init( $wrapper = false, $itemName = 'item', $namespace = null, $version = '' , $rss = 'rss', $stand_alone = false, $wrapperel = '', $url = '', $date = '', $time = '')
    {

...
namespace RexTheme\RexShoppingGoogleCustomSearchAds\Containers;

use RexTheme\RexShoppingGoogleCustomSearchAds\Feed;

class RexShoppingGoogleCustomSearchAds
{
    /**
     * Feed container
     * @var Feed

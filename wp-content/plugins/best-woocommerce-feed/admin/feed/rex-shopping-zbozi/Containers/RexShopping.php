...
namespace RexTheme\RexShoppingZbozi\Containers;

use RexTheme\RexShoppingZbozi\Feed;
...
class RexShopping
{
     ...
     * @return Feed
     */
    public static function init( $wrapper = false, $itemName = 'item', $namespace = 'http://www.zbozi.cz/ns/offer/1.0', $version = '' , $rss = 'rss', $stand_alone = false, $wrapperel = '', $namespace_prefix='')
    {

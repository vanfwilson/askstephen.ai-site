<?php
/**
 * This file is responsible for displaying warning message after making any changes in settings drawer
 *
...
<section class="rex-google-shopping" id="rex_settings_changes_save_warning_popup" style="display: none">
    <div class="rex-google-shopping__wrapper">
        ...
        <div class="rex-google-shopping__body">
			<span class="rex-google-shopping__close-btn" id="rex_settings_changes_close">
            ...
            <div class="rex-google-shopping__message">
                ...
                <div class="rex-google-shopping__btn-area">
                    <a class="rex-google-shopping__btn rex-google-shopping__btn--green" id="rex_abort_settings_changes" target="_self" role="button">
                        <?php esc_html_e( 'No, Close', 'rex-product-feed' ); ?>
                    </a>

                    <a class="rex-google-shopping__btn" id="rex_save_settings" target="_self" role="button">

...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('RexFeed\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['RexFeed\\Google\\Client' => 'Google_Client', 'RexFeed\\Google\\Service' => 'Google_Service', 'RexFeed\\Google\\Service\\Resource' => 'Google_Service_Resource', 'RexFeed\\Google\\Model' => 'Google_Model', 'RexFeed\\Google\\Collection' => 'Google_Collection'];

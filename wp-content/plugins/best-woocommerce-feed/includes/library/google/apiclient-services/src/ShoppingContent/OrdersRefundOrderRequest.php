...
class OrdersRefundOrderRequest extends \RexFeed\Google\Model
{
...
\class_alias(OrdersRefundOrderRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersRefundOrderRequest');

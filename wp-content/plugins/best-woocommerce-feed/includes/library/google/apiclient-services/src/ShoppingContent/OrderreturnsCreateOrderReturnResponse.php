...
class OrderreturnsCreateOrderReturnResponse extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderreturnsCreateOrderReturnResponse::class, 'RexFeed\\Google_Service_ShoppingContent_OrderreturnsCreateOrderReturnResponse');

...
class RegionGeoTargetArea extends \RexFeed\Google\Collection
{
...
\class_alias(RegionGeoTargetArea::class, 'RexFeed\\Google_Service_ShoppingContent_RegionGeoTargetArea');

...
class RepricingRuleReportBuyboxWinningRuleStats extends \RexFeed\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleReportBuyboxWinningRuleStats::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingRuleReportBuyboxWinningRuleStats');

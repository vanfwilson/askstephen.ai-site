...
class OrdersUpdateShipmentRequest extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersUpdateShipmentRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersUpdateShipmentRequest');

...
class AccountImageImprovementsSettings extends \RexFeed\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AccountImageImprovementsSettings::class, 'RexFeed\\Google_Service_ShoppingContent_AccountImageImprovementsSettings');

...
class OrderLineItemProduct extends \RexFeed\Google\Collection
{
...
\class_alias(OrderLineItemProduct::class, 'RexFeed\\Google_Service_ShoppingContent_OrderLineItemProduct');

...
class VerifyPhoneNumberRequest extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VerifyPhoneNumberRequest::class, 'RexFeed\\Google_Service_ShoppingContent_VerifyPhoneNumberRequest');

...
class AccountReturnCarrier extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccountReturnCarrier::class, 'RexFeed\\Google_Service_ShoppingContent_AccountReturnCarrier');

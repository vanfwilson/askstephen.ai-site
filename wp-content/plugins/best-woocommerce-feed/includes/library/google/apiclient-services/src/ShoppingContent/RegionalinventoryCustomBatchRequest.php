...
class RegionalinventoryCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(RegionalinventoryCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_RegionalinventoryCustomBatchRequest');

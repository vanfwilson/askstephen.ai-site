...
class TransitTableTransitTimeRowTransitTimeValue extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(TransitTableTransitTimeRowTransitTimeValue::class, 'RexFeed\\Google_Service_ShoppingContent_TransitTableTransitTimeRowTransitTimeValue');

...
class ReturnpolicyCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(ReturnpolicyCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnpolicyCustomBatchRequest');

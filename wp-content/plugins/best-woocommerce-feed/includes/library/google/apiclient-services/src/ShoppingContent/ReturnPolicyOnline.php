...
class ReturnPolicyOnline extends \RexFeed\Google\Collection
{
...
\class_alias(ReturnPolicyOnline::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnPolicyOnline');

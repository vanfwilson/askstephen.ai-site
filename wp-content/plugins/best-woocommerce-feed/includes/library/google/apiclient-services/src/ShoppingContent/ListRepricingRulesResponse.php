...
class ListRepricingRulesResponse extends \RexFeed\Google\Collection
{
...
\class_alias(ListRepricingRulesResponse::class, 'RexFeed\\Google_Service_ShoppingContent_ListRepricingRulesResponse');

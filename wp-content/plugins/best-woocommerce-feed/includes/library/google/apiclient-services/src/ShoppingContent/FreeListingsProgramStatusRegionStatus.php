...
class FreeListingsProgramStatusRegionStatus extends \RexFeed\Google\Collection
{
...
\class_alias(FreeListingsProgramStatusRegionStatus::class, 'RexFeed\\Google_Service_ShoppingContent_FreeListingsProgramStatusRegionStatus');

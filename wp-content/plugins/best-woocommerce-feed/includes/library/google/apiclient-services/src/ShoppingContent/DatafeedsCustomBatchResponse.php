...
class DatafeedsCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(DatafeedsCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_DatafeedsCustomBatchResponse');

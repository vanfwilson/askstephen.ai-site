...
class AccountsCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(AccountsCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_AccountsCustomBatchRequest');

...
class LiasettingsCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(LiasettingsCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_LiasettingsCustomBatchResponse');

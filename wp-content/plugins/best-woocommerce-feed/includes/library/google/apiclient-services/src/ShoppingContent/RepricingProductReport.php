...
class RepricingProductReport extends \RexFeed\Google\Collection
{
...
\class_alias(RepricingProductReport::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingProductReport');

...
class AccounttaxCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(AccounttaxCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_AccounttaxCustomBatchRequest');

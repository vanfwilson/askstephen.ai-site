...
class ShoppingAdsProgramStatus extends \RexFeed\Google\Collection
{
...
\class_alias(ShoppingAdsProgramStatus::class, 'RexFeed\\Google_Service_ShoppingContent_ShoppingAdsProgramStatus');

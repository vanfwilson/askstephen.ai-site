...
class AccountsAuthInfoResponse extends \RexFeed\Google\Collection
{
...
\class_alias(AccountsAuthInfoResponse::class, 'RexFeed\\Google_Service_ShoppingContent_AccountsAuthInfoResponse');

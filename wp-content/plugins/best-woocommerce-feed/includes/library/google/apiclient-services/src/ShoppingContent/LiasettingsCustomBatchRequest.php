...
class LiasettingsCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(LiasettingsCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_LiasettingsCustomBatchRequest');

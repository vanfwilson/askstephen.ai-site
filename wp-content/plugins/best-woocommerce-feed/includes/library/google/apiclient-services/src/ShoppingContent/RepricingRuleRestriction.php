...
class RepricingRuleRestriction extends \RexFeed\Google\Model
{
...
\class_alias(RepricingRuleRestriction::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingRuleRestriction');

...
class BuyOnGoogleProgramStatus extends \RexFeed\Google\Collection
{
...
\class_alias(BuyOnGoogleProgramStatus::class, 'RexFeed\\Google_Service_ShoppingContent_BuyOnGoogleProgramStatus');

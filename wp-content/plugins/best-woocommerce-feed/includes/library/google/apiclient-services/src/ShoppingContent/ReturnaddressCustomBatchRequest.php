...
class ReturnaddressCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(ReturnaddressCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnaddressCustomBatchRequest');

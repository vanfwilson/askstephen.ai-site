...
class OrderShipmentScheduledDeliveryDetails extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderShipmentScheduledDeliveryDetails::class, 'RexFeed\\Google_Service_ShoppingContent_OrderShipmentScheduledDeliveryDetails');

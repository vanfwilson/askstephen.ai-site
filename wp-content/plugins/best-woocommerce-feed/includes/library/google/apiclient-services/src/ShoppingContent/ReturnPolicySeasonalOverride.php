...
class ReturnPolicySeasonalOverride extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnPolicySeasonalOverride::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnPolicySeasonalOverride');

...
class AccounttaxCustomBatchResponseEntry extends \RexFeed\Google\Model
{
...
\class_alias(AccounttaxCustomBatchResponseEntry::class, 'RexFeed\\Google_Service_ShoppingContent_AccounttaxCustomBatchResponseEntry');

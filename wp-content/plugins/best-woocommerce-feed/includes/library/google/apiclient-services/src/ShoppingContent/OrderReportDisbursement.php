...
class OrderReportDisbursement extends \RexFeed\Google\Model
{
...
\class_alias(OrderReportDisbursement::class, 'RexFeed\\Google_Service_ShoppingContent_OrderReportDisbursement');

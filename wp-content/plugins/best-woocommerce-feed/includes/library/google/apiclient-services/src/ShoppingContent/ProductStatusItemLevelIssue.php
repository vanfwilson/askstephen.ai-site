...
class ProductStatusItemLevelIssue extends \RexFeed\Google\Collection
{
...
\class_alias(ProductStatusItemLevelIssue::class, 'RexFeed\\Google_Service_ShoppingContent_ProductStatusItemLevelIssue');

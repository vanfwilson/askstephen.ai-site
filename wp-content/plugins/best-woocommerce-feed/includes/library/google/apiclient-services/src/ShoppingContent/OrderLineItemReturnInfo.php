...
class OrderLineItemReturnInfo extends \RexFeed\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(OrderLineItemReturnInfo::class, 'RexFeed\\Google_Service_ShoppingContent_OrderLineItemReturnInfo');

...
class AccounttaxCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(AccounttaxCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_AccounttaxCustomBatchResponse');

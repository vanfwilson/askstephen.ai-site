...
class PosCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PosCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_PosCustomBatchRequestEntry');

...
class AccountImageImprovements extends \RexFeed\Google\Model
{
...
\class_alias(AccountImageImprovements::class, 'RexFeed\\Google_Service_ShoppingContent_AccountImageImprovements');

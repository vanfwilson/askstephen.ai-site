...
class ReturnpolicyCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(ReturnpolicyCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnpolicyCustomBatchResponse');

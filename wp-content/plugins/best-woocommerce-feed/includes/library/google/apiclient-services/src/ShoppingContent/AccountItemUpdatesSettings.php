...
class AccountItemUpdatesSettings extends \RexFeed\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AccountItemUpdatesSettings::class, 'RexFeed\\Google_Service_ShoppingContent_AccountItemUpdatesSettings');

...
class RegionalinventoryCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(RegionalinventoryCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_RegionalinventoryCustomBatchResponse');

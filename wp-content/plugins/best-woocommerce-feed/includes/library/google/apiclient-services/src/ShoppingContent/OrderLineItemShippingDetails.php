...
class OrderLineItemShippingDetails extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderLineItemShippingDetails::class, 'RexFeed\\Google_Service_ShoppingContent_OrderLineItemShippingDetails');

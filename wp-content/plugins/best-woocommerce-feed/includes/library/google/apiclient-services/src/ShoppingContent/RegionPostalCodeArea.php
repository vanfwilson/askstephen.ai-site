...
class RegionPostalCodeArea extends \RexFeed\Google\Collection
{
...
\class_alias(RegionPostalCodeArea::class, 'RexFeed\\Google_Service_ShoppingContent_RegionPostalCodeArea');

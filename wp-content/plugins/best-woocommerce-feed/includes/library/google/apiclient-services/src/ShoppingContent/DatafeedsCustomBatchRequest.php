...
class DatafeedsCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(DatafeedsCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_DatafeedsCustomBatchRequest');

...
class ProductDeliveryTimeAreaDeliveryTimeDeliveryTime extends \RexFeed\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ProductDeliveryTimeAreaDeliveryTimeDeliveryTime::class, 'RexFeed\\Google_Service_ShoppingContent_ProductDeliveryTimeAreaDeliveryTimeDeliveryTime');

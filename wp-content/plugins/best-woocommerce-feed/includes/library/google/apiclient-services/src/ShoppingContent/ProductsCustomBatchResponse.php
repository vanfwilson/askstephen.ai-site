...
class ProductsCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(ProductsCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_ProductsCustomBatchResponse');

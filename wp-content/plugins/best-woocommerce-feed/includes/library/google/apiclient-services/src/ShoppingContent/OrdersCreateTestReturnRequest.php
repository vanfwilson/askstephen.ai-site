...
class OrdersCreateTestReturnRequest extends \RexFeed\Google\Collection
{
...
\class_alias(OrdersCreateTestReturnRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersCreateTestReturnRequest');

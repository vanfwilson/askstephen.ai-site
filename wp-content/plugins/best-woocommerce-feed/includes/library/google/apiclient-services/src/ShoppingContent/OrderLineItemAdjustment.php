...
class OrderLineItemAdjustment extends \RexFeed\Google\Model
{
...
\class_alias(OrderLineItemAdjustment::class, 'RexFeed\\Google_Service_ShoppingContent_OrderLineItemAdjustment');

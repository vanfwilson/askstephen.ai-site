...
class ReturnaddressCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnaddressCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnaddressCustomBatchRequestEntry');

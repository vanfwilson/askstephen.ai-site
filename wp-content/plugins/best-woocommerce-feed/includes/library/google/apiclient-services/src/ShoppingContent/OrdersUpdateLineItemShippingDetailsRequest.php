...
class OrdersUpdateLineItemShippingDetailsRequest extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersUpdateLineItemShippingDetailsRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersUpdateLineItemShippingDetailsRequest');

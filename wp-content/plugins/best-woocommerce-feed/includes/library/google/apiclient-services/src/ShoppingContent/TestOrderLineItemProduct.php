...
class TestOrderLineItemProduct extends \RexFeed\Google\Collection
{
...
\class_alias(TestOrderLineItemProduct::class, 'RexFeed\\Google_Service_ShoppingContent_TestOrderLineItemProduct');

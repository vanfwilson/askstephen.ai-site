...
class RequestPhoneVerificationRequest extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RequestPhoneVerificationRequest::class, 'RexFeed\\Google_Service_ShoppingContent_RequestPhoneVerificationRequest');

...
class PosCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(PosCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_PosCustomBatchRequest');

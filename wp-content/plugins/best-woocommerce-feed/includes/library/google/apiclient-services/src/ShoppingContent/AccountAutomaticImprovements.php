...
class AccountAutomaticImprovements extends \RexFeed\Google\Model
{
...
\class_alias(AccountAutomaticImprovements::class, 'RexFeed\\Google_Service_ShoppingContent_AccountAutomaticImprovements');

...
class OrderLineItemShippingDetailsMethod extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderLineItemShippingDetailsMethod::class, 'RexFeed\\Google_Service_ShoppingContent_OrderLineItemShippingDetailsMethod');

...
class AccounttaxCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccounttaxCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_AccounttaxCustomBatchRequestEntry');

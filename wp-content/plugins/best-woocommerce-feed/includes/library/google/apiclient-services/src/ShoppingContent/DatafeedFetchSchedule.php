...
class DatafeedFetchSchedule extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DatafeedFetchSchedule::class, 'RexFeed\\Google_Service_ShoppingContent_DatafeedFetchSchedule');

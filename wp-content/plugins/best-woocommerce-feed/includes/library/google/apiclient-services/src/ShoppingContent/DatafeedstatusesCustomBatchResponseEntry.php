...
class DatafeedstatusesCustomBatchResponseEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DatafeedstatusesCustomBatchResponseEntry::class, 'RexFeed\\Google_Service_ShoppingContent_DatafeedstatusesCustomBatchResponseEntry');

...
class OrderReportTransaction extends \RexFeed\Google\Model
{
...
\class_alias(OrderReportTransaction::class, 'RexFeed\\Google_Service_ShoppingContent_OrderReportTransaction');

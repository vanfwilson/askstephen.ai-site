...
class RepricingRuleRestrictionBoundary extends \RexFeed\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleRestrictionBoundary::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingRuleRestrictionBoundary');

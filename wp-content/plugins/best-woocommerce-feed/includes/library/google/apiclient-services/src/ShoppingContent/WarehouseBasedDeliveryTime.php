...
class WarehouseBasedDeliveryTime extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(WarehouseBasedDeliveryTime::class, 'RexFeed\\Google_Service_ShoppingContent_WarehouseBasedDeliveryTime');

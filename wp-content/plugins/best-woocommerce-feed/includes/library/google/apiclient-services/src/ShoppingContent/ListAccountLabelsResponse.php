...
class ListAccountLabelsResponse extends \RexFeed\Google\Collection
{
...
\class_alias(ListAccountLabelsResponse::class, 'RexFeed\\Google_Service_ShoppingContent_ListAccountLabelsResponse');

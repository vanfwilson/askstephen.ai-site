...
class ReturnpolicyCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnpolicyCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnpolicyCustomBatchRequestEntry');

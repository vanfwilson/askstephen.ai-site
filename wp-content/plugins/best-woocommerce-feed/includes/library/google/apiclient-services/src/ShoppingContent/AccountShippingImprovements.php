...
class AccountShippingImprovements extends \RexFeed\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(AccountShippingImprovements::class, 'RexFeed\\Google_Service_ShoppingContent_AccountShippingImprovements');

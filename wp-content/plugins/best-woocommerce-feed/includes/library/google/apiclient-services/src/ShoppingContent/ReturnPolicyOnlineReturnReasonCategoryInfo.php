...
class ReturnPolicyOnlineReturnReasonCategoryInfo extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ReturnPolicyOnlineReturnReasonCategoryInfo::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnPolicyOnlineReturnReasonCategoryInfo');

...
class OrderreturnsProcessRequest extends \RexFeed\Google\Collection
{
...
\class_alias(OrderreturnsProcessRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrderreturnsProcessRequest');

...
class MerchantOrderReturn extends \RexFeed\Google\Collection
{
...
\class_alias(MerchantOrderReturn::class, 'RexFeed\\Google_Service_ShoppingContent_MerchantOrderReturn');

...
class ShippingsettingsCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ShippingsettingsCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_ShippingsettingsCustomBatchRequestEntry');

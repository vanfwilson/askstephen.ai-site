...
class PubsubNotificationSettings extends \RexFeed\Google\Collection
{
...
\class_alias(PubsubNotificationSettings::class, 'RexFeed\\Google_Service_ShoppingContent_PubsubNotificationSettings');

...
class LiaInventorySettings extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiaInventorySettings::class, 'RexFeed\\Google_Service_ShoppingContent_LiaInventorySettings');

...
class RepricingRuleReport extends \RexFeed\Google\Collection
{
...
\class_alias(RepricingRuleReport::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingRuleReport');

...
class ProductsCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(ProductsCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_ProductsCustomBatchRequest');

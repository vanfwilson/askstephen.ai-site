...
class TestOrderPickupDetails extends \RexFeed\Google\Collection
{
...
\class_alias(TestOrderPickupDetails::class, 'RexFeed\\Google_Service_ShoppingContent_TestOrderPickupDetails');

...
class InapplicabilityDetails extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InapplicabilityDetails::class, 'RexFeed\\Google_Service_ShoppingContent_InapplicabilityDetails');

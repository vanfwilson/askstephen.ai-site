...
class LocalinventoryCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LocalinventoryCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_LocalinventoryCustomBatchRequestEntry');

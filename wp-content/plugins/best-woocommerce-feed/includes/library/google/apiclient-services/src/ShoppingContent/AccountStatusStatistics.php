...
class AccountStatusStatistics extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccountStatusStatistics::class, 'RexFeed\\Google_Service_ShoppingContent_AccountStatusStatistics');

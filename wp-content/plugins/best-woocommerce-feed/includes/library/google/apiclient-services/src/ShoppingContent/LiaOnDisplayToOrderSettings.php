...
class LiaOnDisplayToOrderSettings extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LiaOnDisplayToOrderSettings::class, 'RexFeed\\Google_Service_ShoppingContent_LiaOnDisplayToOrderSettings');

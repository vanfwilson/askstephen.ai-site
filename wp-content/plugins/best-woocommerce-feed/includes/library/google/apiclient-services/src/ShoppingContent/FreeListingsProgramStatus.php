...
class FreeListingsProgramStatus extends \RexFeed\Google\Collection
{
...
\class_alias(FreeListingsProgramStatus::class, 'RexFeed\\Google_Service_ShoppingContent_FreeListingsProgramStatus');

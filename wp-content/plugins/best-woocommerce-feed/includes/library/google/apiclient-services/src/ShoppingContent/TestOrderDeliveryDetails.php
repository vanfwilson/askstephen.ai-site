...
class TestOrderDeliveryDetails extends \RexFeed\Google\Model
{
...
\class_alias(TestOrderDeliveryDetails::class, 'RexFeed\\Google_Service_ShoppingContent_TestOrderDeliveryDetails');

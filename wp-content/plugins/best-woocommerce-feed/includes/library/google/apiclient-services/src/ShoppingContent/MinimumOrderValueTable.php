...
class MinimumOrderValueTable extends \RexFeed\Google\Collection
{
...
\class_alias(MinimumOrderValueTable::class, 'RexFeed\\Google_Service_ShoppingContent_MinimumOrderValueTable');

...
class OrdersRefundItemRequest extends \RexFeed\Google\Collection
{
...
\class_alias(OrdersRefundItemRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersRefundItemRequest');

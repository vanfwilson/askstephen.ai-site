...
class AccountsCustomBatchRequestEntry extends \RexFeed\Google\Collection
{
...
\class_alias(AccountsCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_AccountsCustomBatchRequestEntry');

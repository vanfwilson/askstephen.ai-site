...
class OrdersSetLineItemMetadataRequest extends \RexFeed\Google\Collection
{
...
\class_alias(OrdersSetLineItemMetadataRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersSetLineItemMetadataRequest');

...
class ProductStatusDestinationStatus extends \RexFeed\Google\Collection
{
...
\class_alias(ProductStatusDestinationStatus::class, 'RexFeed\\Google_Service_ShoppingContent_ProductStatusDestinationStatus');

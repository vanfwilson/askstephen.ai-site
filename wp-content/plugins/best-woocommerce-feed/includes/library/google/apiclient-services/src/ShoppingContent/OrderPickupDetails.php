...
class OrderPickupDetails extends \RexFeed\Google\Collection
{
...
\class_alias(OrderPickupDetails::class, 'RexFeed\\Google_Service_ShoppingContent_OrderPickupDetails');

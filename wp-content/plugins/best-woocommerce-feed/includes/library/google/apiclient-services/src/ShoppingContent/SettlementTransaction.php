...
class SettlementTransaction extends \RexFeed\Google\Model
{
...
\class_alias(SettlementTransaction::class, 'RexFeed\\Google_Service_ShoppingContent_SettlementTransaction');

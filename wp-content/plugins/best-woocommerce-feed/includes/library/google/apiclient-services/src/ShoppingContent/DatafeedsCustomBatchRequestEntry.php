...
class DatafeedsCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DatafeedsCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_DatafeedsCustomBatchRequestEntry');

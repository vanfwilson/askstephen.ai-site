...
class LocalinventoryCustomBatchRequest extends \RexFeed\Google\Collection
{
...
\class_alias(LocalinventoryCustomBatchRequest::class, 'RexFeed\\Google_Service_ShoppingContent_LocalinventoryCustomBatchRequest');

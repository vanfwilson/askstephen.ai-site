...
class OrdersShipLineItemsRequest extends \RexFeed\Google\Collection
{
...
\class_alias(OrdersShipLineItemsRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersShipLineItemsRequest');

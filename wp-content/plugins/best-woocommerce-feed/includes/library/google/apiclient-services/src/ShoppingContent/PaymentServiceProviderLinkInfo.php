...
class PaymentServiceProviderLinkInfo extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PaymentServiceProviderLinkInfo::class, 'RexFeed\\Google_Service_ShoppingContent_PaymentServiceProviderLinkInfo');

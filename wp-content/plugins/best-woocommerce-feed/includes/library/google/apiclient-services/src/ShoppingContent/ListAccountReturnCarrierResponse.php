...
class ListAccountReturnCarrierResponse extends \RexFeed\Google\Collection
{
...
\class_alias(ListAccountReturnCarrierResponse::class, 'RexFeed\\Google_Service_ShoppingContent_ListAccountReturnCarrierResponse');

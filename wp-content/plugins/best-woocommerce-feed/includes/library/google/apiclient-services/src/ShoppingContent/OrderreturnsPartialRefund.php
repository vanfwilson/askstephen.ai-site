...
class OrderreturnsPartialRefund extends \RexFeed\Google\Model
{
...
\class_alias(OrderreturnsPartialRefund::class, 'RexFeed\\Google_Service_ShoppingContent_OrderreturnsPartialRefund');

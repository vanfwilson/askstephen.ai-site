 ...
 *  </code>
 */
class Accountsbyexternalsellerid extends \RexFeed\Google\Service\Resource
{
    /**
...
\class_alias(Accountsbyexternalsellerid::class, 'RexFeed\\Google_Service_ShoppingContent_Resource_Accountsbyexternalsellerid');

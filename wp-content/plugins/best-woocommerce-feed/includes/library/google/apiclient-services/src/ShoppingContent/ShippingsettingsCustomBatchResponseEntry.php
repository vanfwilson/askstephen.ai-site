...
class ShippingsettingsCustomBatchResponseEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ShippingsettingsCustomBatchResponseEntry::class, 'RexFeed\\Google_Service_ShoppingContent_ShippingsettingsCustomBatchResponseEntry');

...
class OrderCustomerMarketingRightsInfo extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrderCustomerMarketingRightsInfo::class, 'RexFeed\\Google_Service_ShoppingContent_OrderCustomerMarketingRightsInfo');

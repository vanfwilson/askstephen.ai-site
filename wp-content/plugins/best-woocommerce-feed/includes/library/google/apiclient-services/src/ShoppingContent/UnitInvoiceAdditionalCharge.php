...
class UnitInvoiceAdditionalCharge extends \RexFeed\Google\Model
{
...
\class_alias(UnitInvoiceAdditionalCharge::class, 'RexFeed\\Google_Service_ShoppingContent_UnitInvoiceAdditionalCharge');

...
class MerchantOrderReturnItem extends \RexFeed\Google\Collection
{
...
\class_alias(MerchantOrderReturnItem::class, 'RexFeed\\Google_Service_ShoppingContent_MerchantOrderReturnItem');

...
class ShipmentInvoiceLineItemInvoice extends \RexFeed\Google\Collection
{
...
\class_alias(ShipmentInvoiceLineItemInvoice::class, 'RexFeed\\Google_Service_ShoppingContent_ShipmentInvoiceLineItemInvoice');

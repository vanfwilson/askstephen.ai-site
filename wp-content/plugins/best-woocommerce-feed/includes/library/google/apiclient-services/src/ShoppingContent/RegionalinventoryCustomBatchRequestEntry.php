...
class RegionalinventoryCustomBatchRequestEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(RegionalinventoryCustomBatchRequestEntry::class, 'RexFeed\\Google_Service_ShoppingContent_RegionalinventoryCustomBatchRequestEntry');

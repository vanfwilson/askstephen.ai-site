...
class OrdersInStoreRefundLineItemRequest extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(OrdersInStoreRefundLineItemRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrdersInStoreRefundLineItemRequest');

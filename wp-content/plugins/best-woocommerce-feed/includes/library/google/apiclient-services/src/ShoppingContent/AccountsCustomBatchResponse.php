...
class AccountsCustomBatchResponse extends \RexFeed\Google\Collection
{
...
\class_alias(AccountsCustomBatchResponse::class, 'RexFeed\\Google_Service_ShoppingContent_AccountsCustomBatchResponse');

...
class TransitTableTransitTimeRow extends \RexFeed\Google\Collection
{
...
\class_alias(TransitTableTransitTimeRow::class, 'RexFeed\\Google_Service_ShoppingContent_TransitTableTransitTimeRow');

...
class VerifyPhoneNumberResponse extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(VerifyPhoneNumberResponse::class, 'RexFeed\\Google_Service_ShoppingContent_VerifyPhoneNumberResponse');

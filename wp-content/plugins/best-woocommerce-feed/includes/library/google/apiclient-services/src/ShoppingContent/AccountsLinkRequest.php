...
class AccountsLinkRequest extends \RexFeed\Google\Collection
{
...
\class_alias(AccountsLinkRequest::class, 'RexFeed\\Google_Service_ShoppingContent_AccountsLinkRequest');

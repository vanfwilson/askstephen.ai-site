...
class RepricingRuleStatsBasedRule extends \RexFeed\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(RepricingRuleStatsBasedRule::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingRuleStatsBasedRule');

...
class RepricingRuleEffectiveTime extends \RexFeed\Google\Collection
{
...
\class_alias(RepricingRuleEffectiveTime::class, 'RexFeed\\Google_Service_ShoppingContent_RepricingRuleEffectiveTime');

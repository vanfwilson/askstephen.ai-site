...
class OrderinvoicesCreateRefundInvoiceRequest extends \RexFeed\Google\Collection
{
...
\class_alias(OrderinvoicesCreateRefundInvoiceRequest::class, 'RexFeed\\Google_Service_ShoppingContent_OrderinvoicesCreateRefundInvoiceRequest');

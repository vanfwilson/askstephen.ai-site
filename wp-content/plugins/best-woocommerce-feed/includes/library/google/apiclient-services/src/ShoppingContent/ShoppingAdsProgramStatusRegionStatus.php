...
class ShoppingAdsProgramStatusRegionStatus extends \RexFeed\Google\Collection
{
...
\class_alias(ShoppingAdsProgramStatusRegionStatus::class, 'RexFeed\\Google_Service_ShoppingContent_ShoppingAdsProgramStatusRegionStatus');

...
class PosCustomBatchResponseEntry extends \RexFeed\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(PosCustomBatchResponseEntry::class, 'RexFeed\\Google_Service_ShoppingContent_PosCustomBatchResponseEntry');

...
class ReturnPolicyOnlineRestockingFee extends \RexFeed\Google\Model
{
...
\class_alias(ReturnPolicyOnlineRestockingFee::class, 'RexFeed\\Google_Service_ShoppingContent_ReturnPolicyOnlineRestockingFee');

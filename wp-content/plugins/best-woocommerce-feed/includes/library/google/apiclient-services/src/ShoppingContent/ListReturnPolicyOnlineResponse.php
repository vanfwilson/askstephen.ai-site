...
class ListReturnPolicyOnlineResponse extends \RexFeed\Google\Collection
{
...
\class_alias(ListReturnPolicyOnlineResponse::class, 'RexFeed\\Google_Service_ShoppingContent_ListReturnPolicyOnlineResponse');

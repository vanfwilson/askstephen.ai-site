 ...
 */
namespace RexFeed\Google\AccessToken;
...
class Verify
{
    ...
    private function getPublicKey($cert)
    {
        ...
        if (\class_exists('RexFeed\\phpseclib3\\Crypt\\RSA\\PublicKey')) {
    ...
    {
        if (\class_exists('RexFeed\\phpseclib3\\Crypt\\RSA')) {
            return 'RexFeed\\phpseclib3\\Crypt\\RSA';
        }
    ...
    {
        if (\class_exists('RexFeed\\phpseclib3\\Math\\BigInteger')) {
            return 'RexFeed\\phpseclib3\\Math\\BigInteger';
        }
    ...
    {
        if (\class_exists('RexFeed\\phpseclib3\\Crypt\\AES')) {

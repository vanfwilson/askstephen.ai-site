...
use RexFeed\GuzzleHttp\Cookie\CookieJar;
use RexFeed\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \RexFeed\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**

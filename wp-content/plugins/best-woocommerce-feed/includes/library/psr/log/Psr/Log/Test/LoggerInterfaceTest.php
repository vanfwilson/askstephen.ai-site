...
namespace RexFeed\Psr\Log\Test;

use RexFeed\Psr\Log\LoggerInterface;
use RexFeed\Psr\Log\LogLevel;
use RexFeed\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('RexFeed\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('RexFeed\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('RexFeed\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }

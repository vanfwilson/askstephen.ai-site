...
use RexFeed\PhpConsole\Connector;
use RexFeed\PhpConsole\Handler as VendorPhpConsoleHandler;
use RexFeed\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('RexFeed\\PhpConsole\\Connector')) {

...
use RexFeed\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use RexFeed\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use RexFeed\Monolog\Logger;
use RexFeed\Monolog\ResettableInterface;

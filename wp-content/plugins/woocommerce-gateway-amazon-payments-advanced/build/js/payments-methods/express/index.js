...
const maybeRemoveEditButton = () => {
  ...
  if (editAddressButton && editAddressButton.length > 0) {
    for_each_default()(editAddressButton).call(editAddressButton, button => {
      button.remove();
    });
  }
};
...
const AmazonPayInfo = props => {
  ...
  const store = checkoutStore ? (0,external_wp_data_namespaceObject.useDispatch)(checkoutStore) : null;
  (0,external_wp_element_namespaceObject.useEffect)(() => {

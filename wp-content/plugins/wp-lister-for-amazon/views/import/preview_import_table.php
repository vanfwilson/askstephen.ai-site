...
?>  
    ...
    <table id="wpla_import_preview_table" class="csv-table">
        ...
        <tr>
            ...
            <th><?php echo __( 'Name', 'wp-lister-for-amazon' ) ?></th>
            <th><?php echo __( 'SKU', 'wp-lister-for-amazon' ) ?></th>
            <th><?php echo __( 'ASIN', 'wp-lister-for-amazon' ) ?></th>
            <th><?php echo __( 'Qty', 'wp-lister-for-amazon' ) ?></th>
            <th><?php echo __( 'Price', 'wp-lister-for-amazon' ) ?></th>
            <th><?php echo __( 'Listing will be...', 'wp-lister-for-amazon' ) ?></th>
            <th><?php echo __( 'Product will be...', 'wp-lister-for-amazon' ) ?></th>
        </tr>
        </thead>
        <tbody>

						...
						<div class="inside">
							...
							<div id="titlediv" style="margin-bottom:5px;">
								<div id="titlewrap">
									...
									<input type="text" name="wpla_title" size="30" value="<?php echo esc_attr($wpl_account->title); ?>" id="title" autocomplete="off" style="width:65%;">
								</div>
							</div>
							...
							<input type="text" name="wpla_marketplace_id" id="wpl-marketplace_id" value="<?php echo esc_attr( $wpl_account->marketplace_id ); ?>" class="text_input" />
							<br class="clear" />
							...
							<input type="text" name="wpla_merchant_id" id="wpl-merchant_id" value="<?php echo esc_attr( $wpl_account->merchant_id ); ?>" class="text_input" />
							<br class="clear" />
